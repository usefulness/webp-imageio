...
public class WebPWriteParam(locale: Locale?) : ImageWriteParam(locale) {
     ...
     */
    public var method: Int by encoderOptions::method

    /**
     * if non-zero, set the desired target size in bytes.
     * Takes precedence over the @[.setCompressionQuality] parameter.
     */
    public var targetSize: Int by encoderOptions::targetSize

    /**
     * if non-zero, specifies the minimal distortion to try to achieve.
     * Takes precedence over [.setTargetSize].
     */
    public var targetPSNR: Float by encoderOptions::targetPSNR

    /**
     * maximum number of segments to use
     */
    public var segments: Int by encoderOptions::segments

    /**
     * Spatial Noise Shaping. 0=off, 100=maximum.
     */
    public var snsStrength: Int by encoderOptions::snsStrength

    /**
     * range: [0 = off .. 100 = strongest]
     */
    public var filterStrength: Int by encoderOptions::filterStrength

    /**
     * range: [0 = off .. 7 = least sharp]
     */
    public var filterSharpness: Int by encoderOptions::filterSharpness

    /**
     * filtering type: 0 = simple, 1 = strong (only used if filter_strength > 0 or autofilter > 0)
     */
    public var filterType: Int by encoderOptions::filterType

    /**
     * Auto adjust filter's strength
     */
    public var autoAdjustFilterStrength: Boolean by encoderOptions::autoAdjustFilterStrength

    /**
     * Algorithm for encoding the alpha plane
     * (0 = none, 1 = compressed with WebP lossless). Default is 1.
     */
    public var alphaCompressionAlgorithm: Int by encoderOptions::alphaCompressionAlgorithm

    /**
     * Predictive filtering method for alpha plane.
     * 0: none, 1: fast, 2: best. Default if 1.
     */
    public var alphaFiltering: Int by encoderOptions::alphaFiltering

    /**
     * 0: smallest size, 100: lossless. Default is 100.
     */
    public var alphaQuality: Int by encoderOptions::alphaQuality

    /**
     * Number of entropy-analysis passes
     */
    public var entropyAnalysisPassCount: Int by encoderOptions::entropyAnalysisPassCount

    /**
     * if true, export the compressed picture back. In-loop filtering is not applied.
     */
    public var showCompressed: Boolean by encoderOptions::showCompressed
     ...
     */
    public var partitions: Int by encoderOptions::partitions
     ...
     */
    public var partitionLimit: Int by encoderOptions::partitionLimit
     ...
     */
    public var emulateJpegSize: Boolean by encoderOptions::emulateJpegSize

    /**
     * If non-zero, try and use multi-threaded encoding.
     */
    public var threadLevel: Int by encoderOptions::threadLevel

    /**
     * If set, reduce memory usage (but increase CPU use).
     */
    public var lowMemory: Boolean by encoderOptions::lowMemory

    /**
     * Near lossless encoding
     * 0 = max loss, 100 = off (default)
     */
    public var nearLossless: Int by encoderOptions::nearLossless
     ...
     */
    public var exact: Boolean by encoderOptions::exact

    /**
     * reserved for future lossless feature
     */
    public var useDeltaPalette: Boolean by encoderOptions::useDeltaPalette

    /**
     * if needed, use sharp (and slow) RGB->YUV conversion
     */
    public var useSharpYUV: Boolean by encoderOptions::useSharpYUV

    /**
     * minimum permissible quality factor
     */
    public var qMin: Int by encoderOptions::qMin

    /**
     * maximum permissible quality factor
     */
    public var qMax: Int by encoderOptions::qMax
